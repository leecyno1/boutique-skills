...
| [Short-video automation](https://www.xiaohongshu.com/explore/6a6bdb8c0000000033032c8e) | [Hao0321/video-autopilot-kit](https://github.com/Hao0321/video-autopilot-kit) | MIT project for ffmpeg-first Shorts/long-form/interview production, CapCut draft automation, delivery QA, teardown, templates, and compliance knowledge. Upstream has no `SKILL.md`; the reviewed project scores 88/100. | Imported on 2026-08-05 as `video-autopilot-kit` with a local Agent Skill routing layer. |
...
| video-autopilot-kit | 1,728 | MIT | Imported with local Agent Skill wrapper; 88/100 |
| GSAP AI Skills | 12,806 | MIT | `aed9cfd3277740755f6bfc1155c7aa645403b760` |

Table metadata was verified on 2026-08-01; the Video Autopilot Kit figures were refreshed on 2026-08-05.

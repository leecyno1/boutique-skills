...
|---|---|---|---|
| [AI UI taste](https://www.xiaohongshu.com/explore/6a69f62f0000000010026597) | [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill), [pbakaus/impeccable](https://github.com/pbakaus/impeccable) | Taste Skill is already mirrored as its full multi-skill pack. Impeccable is an Apache-2.0 design system skill with design review, implementation playbooks, detectors, and 20+ focused commands. | Taste: no duplicate import. Impeccable: imported as `impeccable`. |
